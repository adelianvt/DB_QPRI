      ...
      <tbody class="divide-y divide-gray-200">
        @forelse(($approvedList ?? []) as $p)
          ...
          <tr class="hover:bg-gray-50">
            ...
            <td class="px-6 py-4">
              <span class="inline-flex items-center px-4 py-1.5 rounded-full text-xs font-medium border border-green-600 text-green-600 bg-green-50">
                {{ $statusText($p) }}
              </span>
            </td>
          </tr>
        @empty
          <tr><td colspan="6" class="px-6 py-10 text-center text-slate-500">Tidak ada data approved.</td></tr>
        @endforelse
      </tbody>
    </table>
  </div>
      ...
      <tbody class="divide-y divide-gray-200">
        @forelse(($rejectedList ?? []) as $p)
          ...
          <tr class="hover:bg-gray-50">
            ...
            <td class="px-6 py-4 text-sm text-gray-900">{{ optional($p->created_at)->format('Y-m-d') }}</td>
            <td class="px-6 py-4">
              <span class="inline-flex items-center px-4 py-1.5 rounded-full text-xs font-medium border border-red-600 text-red-600 bg-red-50">
                {{ $statusText($p) }}
              </span>
            </td>
          </tr>
        @empty
          <tr><td colspan="6" class="px-6 py-10 text-center text-slate-500">Tidak ada data rejected.</td></tr>
        @endforelse
      </tbody>
    </table>
  </div>
